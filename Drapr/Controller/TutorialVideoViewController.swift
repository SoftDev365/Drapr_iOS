...
class TutorialVideoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Able to play when even silent mode
        do {
        ...
        //video
        let videoPath = Bundle.main.path(forResource: "instructional-video-v2-part1-compressed-rotated", ofType: "mp4")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //img_FrontOfVideo.image = generateThumbnailForVideoAtURL(filePathLocal: "instructional-video-v2-part1-compressed-rotated.mp4")
    ...
    @objc func movieFinish() {
        ...
        self.performSegue(withIdentifier: StorySegues.FromTutorialVCToHowDressVC.rawValue, sender: self)
    }
